...
HD_PWD='C:/Users/John/Documents/GitHub/MQP/mqp_test/mqp_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mqp_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mqp_top.tcl -notrace
