...
HD_PWD='C:/Users/John/Documents/GitHub/MQP/mqp_test/mqp_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mqp_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mqp_top.tcl
