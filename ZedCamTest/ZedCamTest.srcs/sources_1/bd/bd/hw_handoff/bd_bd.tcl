...
proc create_root_design { parentCell } {
  ...
  set SW_camSelect [ create_bd_port -dir I SW_camSelect ]
  set SW_read_fifo [ create_bd_port -dir I SW_read_fifo ]
  ...
  set rgb [ create_bd_port -dir O -from 7 -to 0 rgb ]
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#I2C 0#I2C 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#UART 1#UART 1#GPIO#GPIO#GPIO#GPIO} \
CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#scl#sda#gpio[16]#gpio[17]#gpio[18]#gpio[19]#gpio[20]#gpio[21]#gpio[22]#gpio[23]#gpio[24]#gpio[25]#gpio[26]#gpio[27]#gpio[28]#gpio[29]#gpio[30]#gpio[31]#gpio[32]#gpio[33]#gpio[34]#gpio[35]#gpio[36]#gpio[37]#gpio[38]#gpio[39]#gpio[40]#gpio[41]#gpio[42]#gpio[43]#gpio[44]#gpio[45]#gpio[46]#gpio[47]#tx#rx#gpio[50]#gpio[51]#gpio[52]#gpio[53]} \
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins ZedCamAXI_0/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net FIFO_DATA_1 [get_bd_ports FIFO_DATA] [get_bd_pins ZedCamAXI_0/FIFO_DATA]
  connect_bd_net -net SW_camSelect_1 [get_bd_ports SW_camSelect] [get_bd_pins ZedCamAXI_0/SW_camSelect]
  connect_bd_net -net SW_read_fifo_1 [get_bd_ports SW_read_fifo] [get_bd_pins ZedCamAXI_0/SW_read_fifo]
  connect_bd_net -net ZedCamAXI_0_FIFO_OE1 [get_bd_ports FIFO_OE1] [get_bd_pins ZedCamAXI_0/FIFO_OE1]
  connect_bd_net -net ZedCamAXI_0_FIFO_OE2 [get_bd_ports FIFO_OE2] [get_bd_pins ZedCamAXI_0/FIFO_OE2]
  connect_bd_net -net ZedCamAXI_0_FIFO_RCK [get_bd_ports FIFO_RCK] [get_bd_pins ZedCamAXI_0/FIFO_RCK]
  connect_bd_net -net ZedCamAXI_0_FIFO_RRST1 [get_bd_ports FIFO_RRST1] [get_bd_pins ZedCamAXI_0/FIFO_RRST1]
  connect_bd_net -net ZedCamAXI_0_FIFO_RRST2 [get_bd_ports FIFO_RRST2] [get_bd_pins ZedCamAXI_0/FIFO_RRST2]
  connect_bd_net -net ZedCamAXI_0_HS [get_bd_ports HS] [get_bd_pins ZedCamAXI_0/HS]
  connect_bd_net -net ZedCamAXI_0_VS [get_bd_ports VS] [get_bd_pins ZedCamAXI_0/VS]
  connect_bd_net -net ZedCamAXI_0_cam_reset [get_bd_ports cam_reset] [get_bd_pins ZedCamAXI_0/cam_reset]
  connect_bd_net -net ZedCamAXI_0_cam_sysclk [get_bd_ports cam_sysclk] [get_bd_pins ZedCamAXI_0/cam_sysclk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ZedCamAXI_0/S_AXI/S_AXI_reg] SEG_ZedCamAXI_0_S_AXI_reg

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.5.12  2016-01-29 bk=1.3547 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port VS -pg 1 -y 580 -defaultsOSRD
preplace port cam_trigger -pg 1 -y 420 -defaultsOSRD
preplace port DDR -pg 1 -y 40 -defaultsOSRD
preplace port SW_read_fifo -pg 1 -y 510 -defaultsOSRD
preplace port SW_camSelect -pg 1 -y 490 -defaultsOSRD
preplace port FIFO_OE1 -pg 1 -y 440 -defaultsOSRD
preplace port cam_reset -pg 1 -y 400 -defaultsOSRD
preplace port cam_rst -pg 1 -y 450 -defaultsOSRD
preplace port FIFO_RCK -pg 1 -y 520 -defaultsOSRD
preplace port FIFO_OE2 -pg 1 -y 480 -defaultsOSRD
preplace port cam_sysclk -pg 1 -y 380 -defaultsOSRD
preplace port trigger -pg 1 -y 470 -defaultsOSRD
preplace port HS -pg 1 -y 560 -defaultsOSRD
preplace port sysclk -pg 1 -y 410 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace port FIFO_RRST1 -pg 1 -y 460 -defaultsOSRD
preplace port FIFO_RRST2 -pg 1 -y 500 -defaultsOSRD
preplace port reset -pg 1 -y 430 -defaultsOSRD
preplace portBus FIFO_DATA -pg 1 -y 530 -defaultsOSRD
...
preplace netloc ZedCamAXI_0_FIFO_RRST2 1 3 1 NJ
preplace netloc ZedCamAXI_0_FIFO_OE2 1 3 1 NJ
preplace netloc FIFO_DATA_1 1 0 3 NJ 530 NJ 530 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 240 410
preplace netloc ZedCamAXI_0_rgb 1 3 1 NJ
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 440 570 NJ
preplace netloc ZedCamAXI_0_FIFO_RCK 1 3 1 NJ
preplace netloc sysclk_1 1 0 3 NJ 420 NJ 420 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 60 NJ 60 NJ
preplace netloc SW_camSelect_1 1 0 3 NJ 490 NJ 490 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 1 430
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 230 420 410 740
preplace netloc ZedCamAXI_0_cam_reset 1 3 1 NJ
preplace netloc reset_1 1 0 3 NJ 430 NJ 430 NJ
preplace netloc ZedCamAXI_0_VS 1 3 1 NJ
preplace netloc ZedCamAXI_0_cam_sysclk 1 3 1 NJ
preplace netloc cam_rst_1 1 0 3 NJ 450 NJ 450 NJ
levelinfo -pg 1 0 220 590 870 1010 -top 0 -bot 630
",
}
