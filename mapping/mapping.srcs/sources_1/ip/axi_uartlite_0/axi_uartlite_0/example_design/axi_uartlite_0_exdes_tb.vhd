...
entity axi_uartlite_0_exdes_tb is

end entity;

architecture tb of axi_uartlite_0_exdes_tb is

component axi_uartlite_0_exdes 
   port (
...
--constant RATIO             : integer := 100000000 / (16 * 19200); 
 function CALC_RATIO ( C_S_AXI_ACLK_FREQ_HZ : integer;
    ...
    constant RATIO : integer := CALC_RATIO(100000000 ,19200);
