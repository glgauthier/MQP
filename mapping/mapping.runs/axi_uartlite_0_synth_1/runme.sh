...
HD_PWD='C:/Users/John/Documents/GitHub/MQP/mapping/mapping.runs/axi_uartlite_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_uartlite_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source axi_uartlite_0.tcl
