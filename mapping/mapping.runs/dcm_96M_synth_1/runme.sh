...
HD_PWD='C:/Users/John/Documents/GitHub/MQP/mapping/mapping.runs/dcm_96M_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dcm_96M.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dcm_96M.tcl
