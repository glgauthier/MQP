...
#
# Generated by Vivado on Tue Nov 01 14:30:22 -0400 2016
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: fuck_mqp.sh [-help]
# usage: fuck_mqp.sh [-lib_map_path]
# usage: fuck_mqp.sh [-noclean_files]
# usage: fuck_mqp.sh [-reset_run]
#
...
# executing this script. Please type 'fuck_mqp.sh -help' for more information.
#
...
# Script info
echo -e "fuck_mqp.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/fuck_mqp/ip/fuck_mqp_processing_system7_0_0/sim/fuck_mqp_processing_system7_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/fuck_mqp/ip/fuck_mqp_axi_gpio_0_2/sim/fuck_mqp_axi_gpio_0_2.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/fuck_mqp/ip/fuck_mqp_rst_processing_system7_0_100M_2/sim/fuck_mqp_rst_processing_system7_0_100M_2.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/fuck_mqp/ip/fuck_mqp_auto_pc_0/sim/fuck_mqp_auto_pc_0.v" \
    "$ref_dir/../../../bd/fuck_mqp/hdl/fuck_mqp.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fuck_mqp xil_defaultlib.glbl -o fuck_mqp_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fuck_mqp_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fuck_mqp.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key fuck_mqp_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fuck_mqp_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fuck_mqp.sh -help\" for more information)\n"
    exit 1
  fi
