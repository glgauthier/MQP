...
HD_PWD='C:/Users/John/Documents/GitHub/MQP/killme/killme.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fuck_mqp_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fuck_mqp_wrapper.tcl
