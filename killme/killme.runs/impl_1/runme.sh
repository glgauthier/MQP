...
HD_PWD='C:/Users/John/Documents/GitHub/MQP/killme/killme.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fuck_mqp_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fuck_mqp_wrapper.tcl -notrace
