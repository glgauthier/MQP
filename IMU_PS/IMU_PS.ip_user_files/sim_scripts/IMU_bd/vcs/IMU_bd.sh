...
# executing this script. Please type 'IMU_bd.sh -help' for more information.
#
...
# Design libraries
design_libs=(xil_defaultlib processing_system7_bfm_v2_0_5)
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../bd/IMU_bd/ipshared/xilinx.com/inout_v1_0/src" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../IMU_PS.srcs/sources_1/bd/IMU_bd/ipshared/xilinx.com/inout_v1_0/src" \
    "$ref_dir/../../../bd/IMU_bd/hdl/IMU_bd.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_bfm_v2_0_5 $vlogan_opts +v2k +incdir+"$ref_dir/../../../bd/IMU_bd/ipshared/xilinx.com/inout_v1_0/src" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../IMU_PS.srcs/sources_1/bd/IMU_bd/ipshared/xilinx.com/inout_v1_0/src" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../bd/IMU_bd/ipshared/xilinx.com/inout_v1_0/src" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../IMU_PS.srcs/sources_1/bd/IMU_bd/ipshared/xilinx.com/inout_v1_0/src" \
    "$ref_dir/../../../bd/IMU_bd/ip/IMU_bd_processing_system7_0_0/sim/IMU_bd_processing_system7_0_0.v" \
    "$ref_dir/../../../bd/IMU_bd/ip/IMU_bd_InOut_0_0/sim/IMU_bd_InOut_0_0.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.IMU_bd xil_defaultlib.glbl -o IMU_bd_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./IMU_bd_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key IMU_bd_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc IMU_bd_simv.daidir)
