...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.IMU_bd \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../bd/IMU_bd/ipshared/xilinx.com/inout_v1_0/src" \
       +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
       +incdir+"../../../../IMU_PS.srcs/sources_1/bd/IMU_bd/ipshared/xilinx.com/inout_v1_0/src" \
