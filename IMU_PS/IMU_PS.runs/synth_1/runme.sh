...
HD_PWD='C:/Users/georges/Documents/GitHub/MQP/IMU_PS/IMU_PS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IMU_bd_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source IMU_bd_wrapper.tcl
