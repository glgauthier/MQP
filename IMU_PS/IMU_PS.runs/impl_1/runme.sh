...
HD_PWD='C:/Users/georges/Documents/GitHub/MQP/IMU_PS/IMU_PS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IMU_bd_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source IMU_bd_wrapper.tcl -notrace
