...
\par\null\par
In this chapter, each sensor's behavior was explored and their implementation into the system was designed such that their data could be combined. With this completed, each sensor's behavior was tested to ensure that their actual behavior matches their documented behavior.
