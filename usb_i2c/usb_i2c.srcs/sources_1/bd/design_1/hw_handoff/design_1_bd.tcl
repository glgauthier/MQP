...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set data_step_enable [ create_bd_port -dir O -from 27 -to 0 -type data data_step_enable ]
  set transmit [ create_bd_port -dir I -type data transmit ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports data_step_enable] [get_bd_pins axi_gpio_0/gpio_io_o]
  ...
  connect_bd_net -net transmit_1 [get_bd_ports transmit] [get_bd_pins axi_gpio_0/gpio2_io_i]
...
preplace port transmit -pg 1 -y -60 -defaultsOSRD -right
preplace portBus data_step_enable -pg 1 -y -100 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 2 -y -300 -defaultsOSRD
...
preplace netloc processing_system7_0_DDR 1 1 4 NJ -210 NJ -210 NJ -210 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 1 3 420 -10 NJ -80 1100
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 NJ -170 770
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 410
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 430 10 750
preplace netloc transmit_1 1 2 3 NJ -90 NJ -90 1140
preplace netloc axi_gpio_0_gpio_io_o 1 2 3 NJ -110 NJ -110 1140
preplace netloc processing_system7_0_FIXED_IO 1 1 4 NJ -190 NJ -190 NJ -190 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 2 1 790
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 -260 400 0 800
levelinfo -pg 1 0 210 590 950 1120 1160 -top -400 -bot 160
",
}
