...
HD_PWD='C:/Users/John/Documents/GitHub/MQP/shitfuck/shitfuck.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log idkman_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source idkman_wrapper.tcl
