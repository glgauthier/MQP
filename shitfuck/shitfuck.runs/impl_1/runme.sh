...
HD_PWD='C:/Users/John/Documents/GitHub/MQP/shitfuck/shitfuck.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log idkman_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source idkman_wrapper.tcl -notrace
