...
HD_PWD='C:/Users/georges/Documents/GitHub/MQP/ZedFinalCams/ZedFinalCams.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log noip_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source noip_top.tcl -notrace
