...
# IP: ip/blk_mem_resultant/blk_mem_resultant.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==blk_mem_resultant || ORIG_REF_NAME==blk_mem_resultant}]
...
# XDC: ip/blk_mem_resultant/blk_mem_resultant_ooc.xdc
