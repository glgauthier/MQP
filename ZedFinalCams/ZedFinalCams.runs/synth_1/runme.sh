...
HD_PWD='C:/Users/georges/Documents/GitHub/MQP/ZedFinalCams/ZedFinalCams.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log noip_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source noip_top.tcl
