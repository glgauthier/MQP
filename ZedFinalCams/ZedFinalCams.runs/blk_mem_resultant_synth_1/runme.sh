...
HD_PWD='C:/Users/georges/Documents/GitHub/MQP/ZedFinalCams/ZedFinalCams.runs/blk_mem_resultant_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_resultant.vds -m64 -mode batch -messageDb vivado.pb -notrace -source blk_mem_resultant.tcl
