...
HD_PWD='C:/Users/georges/Documents/GitHub/MQP/ZedFinalCams/ZedFinalCams.runs/line_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log line_bram.vds -m64 -mode batch -messageDb vivado.pb -notrace -source line_bram.tcl
