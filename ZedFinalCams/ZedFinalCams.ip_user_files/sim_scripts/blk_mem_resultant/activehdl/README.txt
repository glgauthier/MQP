...
#
# Generated by export_simulation on Thu Dec 01 14:10:54 -0500 2016
#
################################################################################
...
switch to the './blk_mem_resultant.sh' script.

./blk_mem_resultant.sh -reset_run
...
./blk_mem_resultant.sh -noclean_files

For more information on the script, please type './blk_mem_resultant.sh -help'.
