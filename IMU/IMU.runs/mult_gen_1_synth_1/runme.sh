...
HD_PWD='C:/Users/georges/Documents/GitHub/MQP/IMU/IMU.runs/mult_gen_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_gen_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mult_gen_1.tcl
