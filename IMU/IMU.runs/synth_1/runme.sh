...
HD_PWD='C:/Users/georges/Documents/GitHub/MQP/IMU/IMU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IMU_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source IMU_top.tcl
