...
HD_PWD='C:/Users/georges/Documents/GitHub/MQP/InOut/InOut.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InOut.vds -m64 -mode batch -messageDb vivado.pb -notrace -source InOut.tcl
