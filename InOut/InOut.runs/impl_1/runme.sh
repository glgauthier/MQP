...
HD_PWD='C:/Users/georges/Documents/GitHub/MQP/InOut/InOut.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log InOut.vdi -applog -m64 -messageDb vivado.pb -mode batch -source InOut.tcl -notrace
